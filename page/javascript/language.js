...
const en = {
    ...
    "text-about-1": "I'm a 23-year-old student.",
    "text-about-2": "I focus on creating video games and video game assets.",
    "text-about-3": "I successfully completed my bachelor's degree in software engineering at <a href='https://fai.utb.cz/' class='text-normal-red underline'>TBU</a>.\n",
    ...
    "text-about-7": "I have been working with various companies, such as Polyperfect, for a long time.",
    ...
    "project-tcw": "This Can't Work!",
    "project-tcw-description": "Forget polishing your own project! Your only goal is to sabotage your opponent's work by any means necessary. Keyboard slamming? Dirty tricks? Relentless sabotage? Absolutely! And when the dust settles, who knows if anyone will actually finish their game?",
    "project-bab": "Baťové a Bačové",
    "project-bab-description": "A project created for Game Jam Zlín 2026 with the theme 'Hard Work'. In the game, you find yourself in the role of a judge in his repetitive work, where the player decides on the punishments of accused people. You need to resolve disputes between the poor and the rich and make sure that both sides tolerate you. At the same time, you need to take bribes from time to time, because it is difficult to pay your own debts from your salary. The dialogues in this game are randomly generated from a selected collection of words and sentences.",
    "project-vykolejen": "Vykolejen",
    "project-vykolejen-description": "This is a project created for Bohemia GameJam 2026. In this addictive game, you’ll have to repair your train before the saboteur can stop you, all while trying to get the train to the destination station as quickly as possible. The second player, on the other hand, must cause enough damage to prevent the train from reaching the station on time.",
    "project-copycat": "Copycat",
    "project-copycat-description": "This is my bachelor's thesis for my software engineering degree at UTB. It is a game created in Unity using 3D generative artificial intelligence. Contains various puzzles for the player to solve.",
...
const cz = {
    ...
    "text-about-me": "O mně",
    "text-about-1": "Jsem 23-letý student, programátor.",
    "text-about-2": "Zaměřuji se na tvorbu video her a videoherních assetů.",
    "text-about-3": "Úspěšně jsem dokončil bakalářské studium softwarového inženýrství na <a href='https://fai.utb.cz/' class='text-normal-red underline'>UTB</a>.\n",
    ...
    "text-about-7": "S různými společnostmi, jako je například Polyperfect, spolupracuji již dlouhou dobu.",
    ...
    "project-tcw": "Tohle Nemůže Fungovat!",
    "project-tcw-description": "Zapomeň na tvorbu vlastního projektu! Tvým jediným cílem je sabotovat práci soupeře jakýmikoliv prostředky. Mlácení do klávesnice? Špinavé triky? Neúprosná sabotáž? Rozhodně! A když slehne prach, kdo ví, jestli někdo svou hru skutečně dokončí?",
    "project-bab": "Baťové a Bačové",
    "project-bab-description": "Projekt vytvořen pro Game Jam Zlín 2026 s tématem 'Robota'. Ve hře se ocitáte v roli soudce v jeho repetetivní práci, kde hráč rozhoduje o trestech obviněných lidí. Je potřeba řešit spory mezi chudými a bohatými a starat se, aby Vás obě strany snášely. Zároveň je potřeba jednou za čas vzít úplatek, protože ze svého platu těžko zaplatíte vlastní pohledávky. Dialogy v této hře jsou náhodně generované z vybrané kolekce slov a vět.",
    "project-vykolejen": "Vykolejen",
    "project-vykolejen-description": "Tento projekt vznikl v rámci Bohemia GameJam 2026. V této návykové hře budete muset opravit svůj vlak dříve, než vás v tom zastaví sabotér, a zároveň se pokusit dovézt vlak do cílové stanice co nejrychleji. Druhý hráč naopak musí způsobit dostatečné škody, aby vlak nedorazil do stanice včas.",
    "project-copycat": "Copycat",
    "project-copycat-description": "Jedná se o mou bakalářskou práci v rámci studia softwarového inženýrství na UTB. Je to hra vytvořená v Unity pomocí 3D generativní umělé inteligence. Obsahuje různé hádanky, které musí hráč vyřešit.",
...
const blank = {
    ...
    "project-tcw": "",
    "project-tcw-description": "",
    "project-bab": "",
    "project-bab-description": "",
    "project-vykolejen": "",
    "project-vykolejen-description": "",
    "project-copycat": "",
    "project-copycat-description": "",
    "contact-title": "",
    "contact-work": "",
    "contact-mail": "",
    "text-thats-me": "",
